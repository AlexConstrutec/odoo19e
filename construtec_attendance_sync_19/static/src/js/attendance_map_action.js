...
/** Copia deliberada de construtec_face_attendance_19::attendance_map_action.js
 * - este módulo ya no depende del núcleo (ver su manifest), así que el mapa
 * se adapta acá tal cual en vez de compartir código. */
...
const LEAFLET_CSS = "/construtec_attendance_sync_19/static/src/lib/leaflet/leaflet.css";
const LEAFLET_JS = "/construtec_attendance_sync_19/static/src/lib/leaflet/leaflet.js";
...
export class ConstrutecAttendanceSyncMapAction extends Component {
    static template = "construtec_attendance_sync_19.AttendanceMapAction";
    static props = ["*"];
    ...
    async renderMap() {
        ...
        let result;
        try {
            result = await rpc("/construtec_attendance_sync/map_data", {
...
registry.category("actions").add("construtec_attendance_sync_map", ConstrutecAttendanceSyncMapAction);
