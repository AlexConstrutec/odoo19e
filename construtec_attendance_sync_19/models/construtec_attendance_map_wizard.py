...
class ConstrutecAttendanceSyncMapWizard(models.TransientModel):
    _name = 'construtec.attendance.sync.map.wizard'
    _description = 'Mapa de Marcajes de Asistencia (Community)'
    ...
    def action_view_map(self):
        ...
        return {
            ...
            'tag': 'construtec_attendance_sync_map',
            'name': 'Mapa de Marcajes (Community)',
            'params': {
